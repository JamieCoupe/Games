...
"""This is a naughts and crosses game created by Jamie Coupe based of al Sweigarts book, invert your own games with
 python"""
...
def get_computer_move(board, computer_letter):
    ...
    # Here is our algorithm for our naughts and crosses AI:
...
def play_game():
    print('Welcome to Nuaghts and Crosses!')
